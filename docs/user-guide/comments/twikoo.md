...
> 原栏目：📩 评论插件
> 标签：Notion Repo
> 摘要：Notion Repo现在支持 Twikoo啦，很好用的评论 插件
...
在最新版本中 Notion Repo已经 支持该评论插件，配置 方法很简单：
...
将您的twikoo后台地址配置在Notion Repo的后台，并redeploy即可。
