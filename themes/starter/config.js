...
const CONFIG = {
  ...
  STARTER_FEATURE_TEXT_2:
    'Notion Repo的愿景是帮助您简单、无感知地稳定地搭建自己的网站，放大品牌的价值。 ', // 特性
  ...
  STARTER_ABOUT_TEXT:
    'Notion Repo的愿景是帮助非技术人员的小白，最低成本、最快速地搭建自己的网站，帮助您将自己的产品与故事高效地传达给世界。 <br /> <br /> 功能强大的Notion笔记，简单快速的Vercel托管平台，组成一个简单的网站',
  ...
  STARTER_PRICING_TEXT_2:
    '我们制定了灵活的付费模式，您可以按需选择。（Notion Repo免费开源，这里仅演示产品订阅付费功能，请勿下单购买！）',
  ...
  STARTER_FAQ_1_ANSWER:
    'Notion Repo提供了<a href="https://docs.tangly1024.com/about" className="underline">帮助文档</a>，操作<a href="https://www.bilibili.com/video/BV1fM4y1L7Qi/" className="underline">演示视频</a>，以及<a href="https://docs.tangly1024.com/article/chat-community" className="underline">交流社群</a>来协助您完成网站的搭建部署',
  ...
  STARTER_TEAM_TEXT_2:
    'Notion Repo 由众多开源技术爱好者们共同合作完成，感谢每一位<a className="underline" href="https://github.com/notionnext-org/Notion Repo/graphs/contributors">贡献者</a>',
  ...
  STARTER_BLOG_TEXT_2:
    '这里会发布一些关于Notion Repo的最新动态，包括新的动向、新的未来计划，以及新功能的特性',
