...
1. 浏览 [Discussions](https://github.com/notionnext-org/Notion Repo/discussions)：`组织成员申请`、未回复的「使用问答」。  
2. 扫一眼 [Dependabot PR](https://github.com/notionnext-org/Notion Repo/pulls?q=is%3Apr+author%3Aapp%2Fdependabot)（可批量合并 patch/dev 依赖）。  
...
在 [GOVERNANCE.zh-CN.md](https://github.com/notionnext-org/Notion Repo/blob/main/GOVERNANCE.zh-CN.md#github-设置清单org-admin) 基础上建议：
...
[bug 模板]: https://github.com/notionnext-org/Notion Repo/issues/new?template=bug_report.md
