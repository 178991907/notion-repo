...
export function rateLimitMiddleware(options = {}) {
  ...
  return (req, res, next) => {
    ...
    if (typeof originalJson === 'function' && !originalJson._isMockFunction && !originalJson.mock) {
      ...
      res.end = function(...args) {
        ...
        if (statusCode >= 400) {
          ...
          if (req?.body && Object.keys(req.body).length > 0) {
            // 安全日志：仅记录请求体的键名，不记录实际值（可能包含密码等敏感数据）
