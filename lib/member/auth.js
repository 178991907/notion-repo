...
function getMemberSecret() {
  ...
  // 若未配置，采用进程随机安全密钥，杜绝硬编码弱密钥被伪造
  if (!globalThis.__memberRandomSecret) {
    globalThis.__memberRandomSecret = crypto.randomBytes(32).toString('hex')
  }
  return globalThis.__memberRandomSecret
}
