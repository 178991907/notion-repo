...
> 原栏目：🛠 站点配置
> 标签：Notion Repo
> 摘要：Notion Repo在3.10以后的版本中支持在网站中挂一个公告栏，此功能在3.14版本中完善，所有主题都已支持公告。

::: tip 提示
Notion Repo 3.10以后的版本开始支持网站公告，欢迎更新体验。
...
请升级至最新版本的Notion Repo，参考升级操作指南：

[Notion Repo升级操作指南 | TANGLY’s BLOG](/user-guide/update)
