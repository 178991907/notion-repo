...
function getSecret() {
  ...
  // 若未配置 ADMIN_SECRET 且未配置 ADMIN_PASSWORD，采用进程随机密钥，杜绝固定弱密钥被彩虹表或伪造攻击
  if (!globalThis.__adminRandomSecret) {
    globalThis.__adminRandomSecret = crypto.randomBytes(32).toString('hex')
  }
  return globalThis.__adminRandomSecret
}
