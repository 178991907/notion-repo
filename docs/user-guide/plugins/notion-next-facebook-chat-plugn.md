...
在Notion Repo后台添加两个环境变量即可开启FBChat插件 ， 对应配置文件路径 [blog.config.js](https://github.com/notionnext-org/Notion Repo/blob/70cc96d8f16e71abc8a21e777c4b984680ab5a4b/blog.config.js#L99-L100) 。
