...
配置文件：[`themes/fuwari/config.js`](https://github.com/notionnext-org/Notion Repo/blob/main/themes/fuwari/config.js)  
...
共 **50** 项，上表列出前 40 项，完整列表见 [config.js](https://github.com/notionnext-org/Notion Repo/blob/main/themes/fuwari/config.js)。
