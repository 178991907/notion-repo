...
开启方式，源文件在[blog.config.js](https://github.com/notionnext-org/Notion Repo/blob/8103e23aac7219789c77e412a1bc24dd2a2683b5/blog.config.js#L152C2-L158C1)中，默认是开状态
...
::: tip 提示
由于每个动画模型的高度不同，可能需要您在[代码中](https://github.com/notionnext-org/Notion Repo/blob/8103e23aac7219789c77e412a1bc24dd2a2683b5/components/Live2D.js#L38)修改模型的高度height，否则会很怪异。
