...
如果你第一次接触 Notion Repo，不需要先读完整文档。按下面路线走，先把站点跑起来，再逐步配置主题、域名和运营功能。
...
| 潜在用户 | Notion Repo 和普通博客、Notion 公共页有什么区别 | [首页介绍](../index.md) |
...
Notion Repo 以 Notion 数据库作为内容源。你需要先复制官方模板，然后在自己的 Notion 空间里维护文章、分类、标签、封面和菜单。
...
继续阅读：[Vercel 部署 Notion Repo](./deploy-vercel.md)
...
Notion 公共页面适合分享单页内容；Notion Repo 更适合长期运营独立站。你可以使用自己的域名、主题、SEO、评论、统计、搜索和更多插件。
